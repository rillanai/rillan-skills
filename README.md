...
| `socratic-gate` | Thinking guardrails over design/decision work: synthesis-first gate, decision surfacing, generic-pattern depth audit. Tunable depth (off/light/standard/deep) by risk, persistable via memory. |
