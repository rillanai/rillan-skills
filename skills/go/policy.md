...
This skill is the standards layer for Go tasks. It defines coding rules, architectural expectations, review priorities, and quality bars. It does not define the execution workflow; pair it with `workflow.md` for that.
