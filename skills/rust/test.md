...
- `policy.md` for standards that define maintainable Rust code
...
- Use structural tools (`analyzer.md`) to locate the code under test and its callers; do not guess at signatures, lifetimes, or coverage.
...
- documentation work (use `docs.md`)
- security audit work (use `security` or `audit.md`)
