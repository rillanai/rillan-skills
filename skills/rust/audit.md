...
- Prefer structural or type-aware tooling (LSP, `analyzer.md`) for references, trait impls, and call graphs; fall back to `cargo expand`, `cargo metadata`, `cargo tree`, and text search when needed.
