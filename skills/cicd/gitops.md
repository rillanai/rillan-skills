...
This skill is platform-agnostic across the two dominant tools (**Argo CD** and **Flux**), with notes where they diverge. Pair it with `core.md` for pipeline principles, `supply-chain.md` for artifact integrity, and `kubernetes/dev.md` for workload manifests.
